...
internal class RegistryOperations
{
	...
	private RegistryOperations(string string_0)
	{
	...
	public static string getProfileStringWithDefault(string string_1, string string_2)
	{
		if (iniPath != null)
		{
			...
			GetPrivateProfileString(SETUP, string_1, string_2, stringBuilder, 1024, iniPath);
	...
	public static int getProfileIntWithDefault(string string_1, int int_1)
	{
		...
		{
			StringBuilder stringBuilder = new StringBuilder(1024);
			GetPrivateProfileString(SETUP, string_1, int_1.ToString(), stringBuilder, 1024, iniPath);
			try
			{
	...
	public static void WriteProfileString(string string_1, string string_2)
	{
		if (iniPath != null)
		{
			WritePrivateProfileString(SETUP, string_1, string_2, iniPath);
		}
		else
		{
	...
	public static void WriteProfileInt(string string_1, int int_1)
	{
		if (iniPath != null)
		{
			WritePrivateProfileString(SETUP, string_1, int_1.ToString(), iniPath);
		}
		else
		{
